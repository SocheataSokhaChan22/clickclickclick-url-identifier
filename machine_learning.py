...
data = {'accuracy': [NB_accuracy, SVM_accuracy, DT_accuracy, RF_accuracy,],
        'precision': [NB_precision, SVM_precision, DT_precision, RF_precision],
        'recall': [NB_recall, SVM_recall, DT_recall, RF_recall]
        }
